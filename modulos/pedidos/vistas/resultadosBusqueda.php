                ...
                <div class="contenidoRestaurante span7">
                    <div class="row-fluid">
                        <div class=" span8 datosRestaurante">
                            ...
                            <div class="datos row-fluid" style="padding-top: 6px;">
                                <?php
                                if ($restaurante->pedidoMinimo == 0) {
                                    echo '<div class="span6" style="margin-top: 4px;margin-bottom: 4px;">';
                                    echo '<span class="datosGreen">No hay pedido mínimo</span>';
                                } else {
                                    echo '<div class="span6">';
                                    echo '<span class="datosRed">Pedido mínimo:</span><br>';
